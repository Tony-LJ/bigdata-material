...
create table if not exists utc.airflow_dag_task_lineage (
    ...
    constraint airflow_dag_task_lineage_ibfk_1 foreign key (upstream_task_id) references airflow_dag_task_pipeline (dag_id,task_id),
    constraint airflow_dag_task_lineage_ibfk_2 foreign key (dwonstream_task_id) references airflow_dag_task_pipeline (dag_id,task_id)
